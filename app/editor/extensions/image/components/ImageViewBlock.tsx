...
import {ElementDimensions, useDragResize} from "@/app/editor/extensions/image/hooks/useDragResize";
import {UploadReturnType} from "@/app/editor/extensions/image/Image";
import {blobUrlToBase64, randomId} from "@/app/editor/extensions/utils";
import {cn, Spinner} from "@nextui-org/react";
import {InfoIcon, TrashIcon} from "lucide-react";
import {ImageOverlay} from "@/app/editor/extensions/image/components/ImageOverlay";
import {ActionButton, ActionWrapper, ImageActions} from "@/app/editor/extensions/image/components/ImageActions";
                    ...
                    {imageState.error && (
                        <ActionWrapper>
                            <ActionButton icon={<TrashIcon
                                className="size-4"/>} tooltip="Remove image"
                                          onClick={onRemoveImg}/>
                        </ActionWrapper>
                    )}
