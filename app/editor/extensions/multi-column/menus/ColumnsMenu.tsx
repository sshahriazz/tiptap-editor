...
export const ColumnsMenu = ({editor, appendTo}: any) => {
    ...
    return (
        ...
        >
            <Button isDisabled={isColumnLeft} onClick={onColumnLeft}>
                <Icon name="PanelLeft"/>
            </Button>
            <Button isDisabled={isColumnTwo} onClick={onColumnTwo}>
                <Icon name="Columns2"/>
            </Button>
            <Button isDisabled={isColumnRight} onClick={onColumnRight}>
